...
function showAdminTab(tabName) {
    ['update', 'concerns', 'chat', 'gallery', 'manage-announcements'].forEach((tab) => {
        ...
        if (buttonElement) buttonElement.classList.remove('active', 'bg-emerald-600', 'text-white');
    });
    ...
    if (tabName === 'chat') {
        ...
        loadGalleryImages();
        loadAdminGalleryPreview();
    } else if (tabName === 'manage-announcements') {
        // Load announcements when the tab is clicked
